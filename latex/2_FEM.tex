...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.3\linewidth}
    \centering
    \includegraphics[height=,width=\linewidth]{網格1mm-1}
    \caption{\Large 較密網格}
    \label{網格1mm-1}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.45\linewidth}
    \centering
    \includegraphics[height=,width=\linewidth]{網格1mm-2}
...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.3\linewidth}
    \centering
    \includegraphics[height=,width=\linewidth]{網格50mm-1}
    \caption{\Large 較粗網格}
    \label{網格50mm-1}
  \end{minipage}
  \hfill
   \begin{minipage}[t]{0.3\linewidth}
    \centering
    \includegraphics[height=,width=\linewidth]{網格50mm-2}
