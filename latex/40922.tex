...
\lstset{language=Python, %設定語言
		basicstyle=\fontsize{14pt}{3pt}\selectfont, %設定程式內文字體大小
...
\vspace{6em} %下移
\fontsize{29pt}{2.5pt}\selectfont\textbf{有限元素法在四足機器人設計上的應用}\\
\vspace{1em}
...
\newcommand{\loflabel}{圖\fontsize{12pt}{14pt}\selectfont}
\renewcommand{\numberline}[1]{\loflabel~\fontsize{14pt}{14pt}\selectfont #1\hspace*{0.5em}}
\listoffigures
