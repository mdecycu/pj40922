...
\lstset{language=Python, %設定語言
		basicstyle=\fontsize{10pt}{3pt}\selectfont, %設定程式內文字體大小
...
%=------------------更改標題內容----------------------=%
\titleformat{\chapter}[hang]{\center\sectionef\fontsize{20pt}{18pt}\bfseries}{\LARGE 第\CJKnumber{\thechapter}章}{1em}{}[]
\titleformat{\section}[hang]{\sectionef\fontsize{18pt}{12pt}\bfseries}{{\thesection}}{0.5pt}{}[]
\titleformat{\subsection}[hang]{\sectionef\fontsize{16pt}{6pt}\bfseries}{{\thesubsection}}{1pt}{}[]
%=------------------更改目錄內容-----------------------=%
...
\hspace{32mm}\makebox[5cm][s]
{指導教授：\quad 李\quad 武\quad 鉦\quad 老\quad 師}\\[6pt]
\hspace{32mm}\makebox[5cm][s]
...
\newpage
%=------------------------謝辭----------------------=%
\addcontentsline{toc}{chapter}{謝~~~辭}
\centerline\LARGE\textbf{謝~~辭}\\
\begin{flushleft}
...
\hspace{-0.5em}：\\
\vspace{0.5em}
\rotatebox[origin=cc]{270}{\sectionef\LARGE \textbf{112-4-CAE-3006、3004-2}}\\ %旋轉
\vspace{0.5em}
有\\
限\\
元\\
