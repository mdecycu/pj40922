...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.45\linewidth}
    \centering
    \includegraphics[height=3.5cm,width=3.5cm]{馬達底座}
    \caption{馬達底座}
    \label{馬達底座}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.45\linewidth}
    \centering
    \includegraphics[height=3.5cm,width=3.5cm]{馬達軸}
    \caption{馬達軸}
    \label{馬達軸}
  \end{minipage}
\end{figure}
...
\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=9cm]{Forward kinematics formula}
...
\begin{figure}[htbp]
  \begin{minipage}[t]{0\linewidth}
    \centering
    \includegraphics[height=3cm,width=4.5cm]{模擬動作-1}
    \caption{模擬動作-1}
    \label{模擬動作-1}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0\linewidth}
    \centering
    \includegraphics[height=3cm,width=4.5cm]{模擬動作-2}
    \caption{模擬動作-2}
    \label{模擬動作-2}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0\linewidth}
    \centering
    \includegraphics[height=3cm,width=4.5cm]{模擬動作-3}
    \caption{模擬動作-3}
    \label{模擬動作-3}
  \end{minipage}
\end{figure}
