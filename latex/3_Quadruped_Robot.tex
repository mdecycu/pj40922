...
\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=1cm]{四足機器人範圍及作用}
\caption{\Large 四足機器人範圍及作用}\label{四足機器人範圍及作用}
\end{center}
\end{figure}
\begin{enumerate}
...
\begin{figure}[htbp]
  ...
  \end{minipage}
\end{figure}
此順向運動學將對步行機構(圖 \ref{步行機構分解圖})至(圖 \ref{步行機構})進行計算，由於四組步行機構為相同模型，因此只要提出一個計算即可。\\
...
\begin{table}[htb!]
  ...
  \begin{tabular}{|p{0.35cm}|p{0.35cm}|p{0.35cm}|p{0.35cm}|p{0.35cm}|p{0.35cm}|p{0.35cm}|}
