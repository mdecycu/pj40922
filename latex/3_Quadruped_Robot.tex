...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.3\linewidth}
    \centering
    \includegraphics[height=4cm,width=4cm]{連接座}
    \caption{馬達連接座}
    \label{馬達連接座}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.3\linewidth}
    \centering
    \includegraphics[height=4cm,width=4cm]{連接座-2}
    \caption{馬達連接座-2}
    \label{馬達連接座-2}
  \end{minipage}
\end{figure}
...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.45\linewidth}
    \centering
    \includegraphics[height=4cm,width=4cm]{步行機構分解圖}
    \caption{步行機構分解圖}
    \label{步行機構分解圖}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.45\linewidth}
    \centering
    \includegraphics[height=4cm,width=4cm]{Forward kinematics formula}
    \caption{四連桿機構}
    \label{Forward kinematics formula}
  \end{minipage}
\end{figure}
