...
此三連桿閉環機構(圖 \ref{三連桿閉環機構(1)})為三個聯桿及三顆馬達組成，此以一個關節連接本體，此種機構優點在於結構較為緊湊、簡單，通過三連桿關節的旋轉角度控制尾端的位置，達到目標動作及整體姿態，具有靈活性、反應快速、定位精度高等優點。\

\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=8cm]{三連桿閉環機構(1)}
...
\begin{figure}[hbt!]
\begin{center}
\includegraphics[width=8cm]{步行機構ggb}
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[width=15cm]{四足機器狗}
